...
// Background rule (iron): bg1×2, bg2×2, cave2×1, cave3×1, bg3×2, bg4×1(boss)
export const ISLAND_STAGE_BG_KEYS = {
  cherry_blossom_island: {
    1: "cherry_blossom_island1",
    2: "cherry_blossom_island1",
    3: "cherry_blossom_island2",
    4: "cherry_blossom_island2",
    5: "2",
    6: "3",
    7: "cherry_blossom_island3",
  ...
  snowy_peaks_island: {
    ...
    2: "snowy_peaks_island1",
    3: "snowy_peaks_island2",
    4: "snowy_peaks_island2",
    5: "2",
    6: "3",
    7: "snowy_peaks_island3",
  ...
  antigravity_island: {
    ...
    2: "antigravity_island1",
    3: "antigravity_island2",
    4: "antigravity_island2",
    5: "2",
    6: "3",
    7: "antigravity_island3",
